...
@implementation NSData (SQBase64)
...
//
+ (NSData *)sq_dataFromBase64String:(NSString *)aString
{
	NSData *data = [aString dataUsingEncoding:NSASCIIStringEncoding];
	size_t outputLength;
	void *outputBuffer = sq_NewBase64Decode([data bytes], [data length], &outputLength);
...
{
	size_t outputLength;
	char *outputBuffer = sq_NewBase64Encode([self bytes], [self length], true, &outputLength);
